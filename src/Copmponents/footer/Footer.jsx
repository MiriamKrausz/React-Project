        ...
        <>
            <div className="footerDiv">
                ...
                <div className='details'>
                    <p className='pDetails'><CallIcon></CallIcon>{BusinessStore.details.phone} </p>
                    <div className='line'></div>
                    <p className='pDetails'><EmailIcon></EmailIcon>{BusinessStore.details.email}</p>
                    <div className='line'></div>
                    <p className='pDetails'><LocationOnIcon></LocationOnIcon> {BusinessStore.details.address}</p>
